    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(blank=True, choices=[('ks', 'Ks'), ('kg', 'Kg'), ('l', 'Liters'), ('mb', 'Cubic Meters'), ('m2', 'Square Meters'), ('hod', 'Hours')], default='ks', max_length=5, null=True, verbose_name='jednotka')),
